...
class Cropper extends React.Component {
  ...
  moveListener (e) {
    ...
    if (this.state.mouse.x && this.state.mouse.y) {
      var dx = this.state.mouse.x - positionX;
      var dy = this.state.mouse.y - positionY;
  ...
  componentDidMount () {
    ...
    this.listeners = {
      move: e => this.moveListener(e),
      up: e => this.upListener(e),
      down: e => this.downListener(e),
    };

    window.addEventListener("mousemove", this.listeners.move, false);
    window.addEventListener("touchmove", this.listeners.move, false);
    window.addEventListener("mousedown", this.listeners.down, false);
    window.addEventListener("touchstart", this.listeners.down, false);
    window.addEventListener("mouseup", this.listeners.up, false);
    window.addEventListener("touchend", this.listeners.up, false);
    canvas.addEventListener("mousedown", this.listeners.down, false);
    canvas.addEventListener("touchstart", this.listeners.down, false);
  ...
  componentWillUnmount () {
    var canvas = ReactDom.findDOMNode(this.refs.canvas);
    window.removeEventListener("mousemove", this.listeners.move, false);
    window.removeEventListener("touchmove", this.listeners.move, false);
    window.removeEventListener("mousedown", this.listeners.down, false);
    window.removeEventListener("touchstart", this.listeners.down, false);
    window.removeEventListener("mouseup", this.listeners.up, false);
    window.removeEventListener("touchend", this.listeners.up, false);
    canvas.removeEventListener("mousedown", this.listeners.down, false);
    canvas.removeEventListener("touchstart", this.listeners.down, false);
  }
